...
*/
alias Z3_error_handler = void function (Z3_context c, Z3_error_code e);
...
*/
void Z3_params_set_bool (Z3_context c, Z3_params p, Z3_symbol k, Z3_bool v);
...
*/
Z3_sort Z3_mk_finite_domain_sort (Z3_context c, Z3_symbol name, ulong size);
...
*/
Z3_ast Z3_mk_bv2int (Z3_context c, Z3_ast t1, Z3_bool is_signed);
...
*/
Z3_ast Z3_mk_bvadd_no_overflow (Z3_context c, Z3_ast t1, Z3_ast t2, Z3_bool is_signed);
...
*/
Z3_ast Z3_mk_bvsub_no_underflow (Z3_context c, Z3_ast t1, Z3_ast t2, Z3_bool is_signed);
...
*/
Z3_ast Z3_mk_bvmul_no_overflow (Z3_context c, Z3_ast t1, Z3_ast t2, Z3_bool is_signed);
...
*/
Z3_ast Z3_mk_int64 (Z3_context c, long v, Z3_sort ty);
...
*/
Z3_ast Z3_mk_unsigned_int64 (Z3_context c, ulong v, Z3_sort ty);
...
Z3_ast Z3_mk_quantifier_ex (
    ...
    uint num_patterns,
    const(Z3_pattern)* patterns,
    uint num_no_patterns,
    const(Z3_ast)* no_patterns,
    uint num_decls,
    const(Z3_sort)* sorts,
    const(Z3_symbol)* decl_names,
    Z3_ast body_);
...
*/
Z3_bool Z3_is_eq_sort (Z3_context c, Z3_sort s1, Z3_sort s2);
...
*/
Z3_bool Z3_get_finite_domain_sort_size (Z3_context c, Z3_sort s, ulong* r);
...
*/
Z3_bool Z3_is_eq_func_decl (Z3_context c, Z3_func_decl f1, Z3_func_decl f2);
...
*/
Z3_string Z3_get_decl_rational_parameter (Z3_context c, Z3_func_decl d, uint idx);
...
*/
Z3_bool Z3_is_eq_ast (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
Z3_bool Z3_is_well_sorted (Z3_context c, Z3_ast t);
...
*/
Z3_bool Z3_is_app (Z3_context c, Z3_ast a);

/**
  def_API('Z3_is_numeral_ast', BOOL, (_in(CONTEXT), _in(AST)))
*/
Z3_bool Z3_is_numeral_ast (Z3_context c, Z3_ast a);
...
*/
Z3_bool Z3_is_algebraic_number (Z3_context c, Z3_ast a);
...
*/
Z3_string Z3_get_numeral_decimal_string (Z3_context c, Z3_ast a, uint precision);
...
*/
Z3_bool Z3_get_numeral_small (Z3_context c, Z3_ast a, long* num, long* den);
...
*/
Z3_bool Z3_get_numeral_int (Z3_context c, Z3_ast v, int* i);
...
*/
Z3_bool Z3_get_numeral_uint (Z3_context c, Z3_ast v, uint* u);
...
*/
Z3_bool Z3_get_numeral_uint64 (Z3_context c, Z3_ast v, ulong* u);
...
*/
Z3_bool Z3_get_numeral_int64 (Z3_context c, Z3_ast v, long* i);
...
*/
Z3_bool Z3_get_numeral_rational_int64 (Z3_context c, Z3_ast v, long* num, long* den);
...
*/
Z3_bool Z3_is_quantifier_forall (Z3_context c, Z3_ast a);
...
*/
Z3_bool Z3_model_has_interp (Z3_context c, Z3_model m, Z3_func_decl a);
...
*/
Z3_bool Z3_is_as_array (Z3_context c, Z3_ast a);
...
*/
Z3_bool Z3_open_log (Z3_string filename);
...
*/
void Z3_toggle_warning_messages (Z3_bool enabled);
...
*/
Z3_ast Z3_parse_smtlib2_string (
    Z3_context c,
    Z3_string str,
    uint num_sorts,
    const(Z3_symbol)* sort_names,
...
*/
uint Z3_get_smtlib_num_formulas (Z3_context c);
...
*/
Z3_ast Z3_get_smtlib_formula (Z3_context c, uint i);
...
*/
uint Z3_get_smtlib_num_assumptions (Z3_context c);
...
*/
Z3_ast Z3_get_smtlib_assumption (Z3_context c, uint i);
...
*/
uint Z3_get_smtlib_num_decls (Z3_context c);
...
*/
Z3_func_decl Z3_get_smtlib_decl (Z3_context c, uint i);
...
*/
uint Z3_get_smtlib_num_sorts (Z3_context c);
...
*/
Z3_sort Z3_get_smtlib_sort (Z3_context c, uint i);
...
*/
Z3_string Z3_get_smtlib_error (Z3_context c);
...
*/
void Z3_set_error_handler (Z3_context c, void function () h);
...
*/
Z3_string Z3_get_error_msg (Z3_error_code err);
...
*/
Z3_string Z3_get_error_msg_ex (Z3_context c, Z3_error_code err);
...
// 
alias Z3_reduce_eq_callback_fptr = int function (Z3_theory t, Z3_ast a, Z3_ast b, Z3_ast* r);

alias Z3_reduce_app_callback_fptr = int function (Z3_theory, Z3_func_decl, uint, const(Z3_ast)*, Z3_ast*);

alias Z3_reduce_distinct_callback_fptr = int function (Z3_theory, uint, const(Z3_ast)*, Z3_ast*);

alias Z3_theory_callback_fptr = void function (Z3_theory t);

alias Z3_theory_final_check_callback_fptr = int function (Z3_theory);

alias Z3_theory_ast_callback_fptr = void function (Z3_theory, Z3_ast);

alias Z3_theory_ast_bool_callback_fptr = void function (Z3_theory, Z3_ast, Z3_bool);

alias Z3_theory_ast_ast_callback_fptr = void function (Z3_theory, Z3_ast, Z3_ast);
...
*/
Z3_theory Z3_mk_theory (Z3_context c, Z3_string th_name, Z3_theory_data data);
...
/**
   ...
   \see Z3_mk_theory
*/
Z3_theory_data Z3_theory_get_ext_data (Z3_theory t);
...
*/
void Z3_set_delete_callback (Z3_theory t, void function () f);
...
*/
void Z3_set_reduce_app_callback (Z3_theory t, int function () f);
...
*/
void Z3_set_reduce_eq_callback (Z3_theory t, int function () f);
...
*/
void Z3_set_reduce_distinct_callback (Z3_theory t, int function () f);
...
*/
void Z3_set_new_app_callback (Z3_theory t, void function () f);
...
/**
   ...
   will remain in the logical context until this level is backtracked.
*/
void Z3_set_new_elem_callback (Z3_theory t, void function () f);
...
/**
   ...
   \conly - \c t is the given theory
*/
void Z3_set_init_search_callback (Z3_theory t, void function () f);
...
/**
   ...
   \conly - \c t is the given theory
*/
void Z3_set_push_callback (Z3_theory t, void function () f);
...
/**
   ...
   \conly - \c t is the given theory
*/
void Z3_set_pop_callback (Z3_theory t, void function () f);
...
/**
   ...
   \conly - \c t is the given theory
*/
void Z3_set_restart_callback (Z3_theory t, void function () f);
...
/**
   ...
   \conly - \c t is the given theory
*/
void Z3_set_reset_callback (Z3_theory t, void function () f);
...
*/
void Z3_set_final_check_callback (Z3_theory t, int function () f);
...
/**
   ...
   \conly   - \c s_2 is the right-hand-side
*/
void Z3_set_new_eq_callback (Z3_theory t, void function () f);
...
/**
   ...
   \conly   - \c s_2 is the right-hand-side
*/
void Z3_set_new_diseq_callback (Z3_theory t, void function () f);
...
*/
void Z3_set_new_assignment_callback (Z3_theory t, void function () f);
...
*/
void Z3_set_new_relevant_callback (Z3_theory t, void function () f);
...
*/
uint Z3_theory_get_num_parents (Z3_theory t, Z3_ast n);

/**
   \brief Return the i-th parent of \c n.
   See #Z3_theory_get_num_parents.
*/
Z3_ast Z3_theory_get_parent (Z3_theory t, Z3_ast n, uint i);
...
*/
uint Z3_theory_get_num_elems (Z3_theory t);
...
*/
Z3_ast Z3_theory_get_elem (Z3_theory t, uint i);
...
*/
uint Z3_theory_get_num_apps (Z3_theory t);
...
*/
Z3_ast Z3_theory_get_app (Z3_theory t, uint i);
...
*/
Z3_lbool Z3_fixedpoint_query (Z3_context c, Z3_fixedpoint d, Z3_ast query);
...
*/
Z3_lbool Z3_fixedpoint_query_relations (
    Z3_context c,
    Z3_fixedpoint d,
    uint num_relations,
    const(Z3_func_decl)* relations);
...
*/
Z3_string Z3_fixedpoint_get_reason_unknown (Z3_context c, Z3_fixedpoint d);
...
void Z3_fixedpoint_set_predicate_representation (
    ...
    Z3_func_decl f,
    uint num_relations,
    const(Z3_symbol)* relation_kinds);
...
*/
Z3_string Z3_fixedpoint_get_help (Z3_context c, Z3_fixedpoint f);
...
*/
void Z3_fixedpoint_push (Z3_context c, Z3_fixedpoint d);
...
*/
void Z3_fixedpoint_pop (Z3_context c, Z3_fixedpoint d);

/**
     \brief The following utilities allows adding user-defined domains.
*/

alias Z3_fixedpoint_reduce_assign_callback_fptr = void function (
    void*,
    Z3_func_decl,
    uint,
    const(Z3_ast)*,
...
alias Z3_fixedpoint_reduce_app_callback_fptr = void function (
    void*,
    Z3_func_decl,
    uint,
    const(Z3_ast)*,
...
*/
uint Z3_optimize_assert_soft (Z3_context c, Z3_optimize o, Z3_ast a, Z3_string weight, Z3_symbol id);
...
*/
Z3_lbool Z3_optimize_check (Z3_context c, Z3_optimize o);
...
*/
Z3_string Z3_optimize_get_help (Z3_context c, Z3_optimize t);
...
*/
Z3_bool Z3_ast_map_contains (Z3_context c, Z3_ast_map m, Z3_ast k);
...
*/
Z3_bool Z3_goal_inconsistent (Z3_context c, Z3_goal g);
...
*/
Z3_bool Z3_goal_is_decided_sat (Z3_context c, Z3_goal g);
...
*/
Z3_bool Z3_goal_is_decided_unsat (Z3_context c, Z3_goal g);
...
*/
Z3_string Z3_get_tactic_name (Z3_context c, uint i);
...
*/
Z3_string Z3_get_probe_name (Z3_context c, uint i);
...
*/
Z3_model Z3_apply_result_convert_model (Z3_context c, Z3_apply_result r, uint i, Z3_model m);
...
*/
Z3_lbool Z3_solver_check_assumptions (
    Z3_context c,
    Z3_solver s,
    uint num_assumptions,
    const(Z3_ast)* assumptions);
...
*/
Z3_string Z3_stats_get_key (Z3_context c, Z3_stats s, uint idx);
...
*/
Z3_bool Z3_stats_is_uint (Z3_context c, Z3_stats s, uint idx);
...
*/
Z3_bool Z3_stats_is_double (Z3_context c, Z3_stats s, uint idx);
...
*/
Z3_func_decl Z3_mk_injective_function (
    Z3_context c,
    Z3_symbol s,
    uint domain_size,
    const(Z3_sort)* domain,
...
*/
Z3_bool Z3_set_logic (Z3_context c, Z3_string logic);
...
*/
void Z3_pop (Z3_context c, uint num_scopes);
...
*/
uint Z3_get_num_scopes (Z3_context c);
...
*/
void Z3_persist_ast (Z3_context c, Z3_ast a, uint num_scopes);
...
*/
Z3_lbool Z3_check (Z3_context c);
...
*/
Z3_lbool Z3_get_implied_equalities (
    Z3_context c,
    Z3_solver s,
    uint num_terms,
    const(Z3_ast)* terms,
...
*/
void Z3_soft_check_cancel (Z3_context c);
...
*/
Z3_search_failure Z3_get_search_failure (Z3_context c);
...
*/
Z3_ast Z3_mk_label (Z3_context c, Z3_symbol s, Z3_bool is_pos, Z3_ast f);
...
*/
Z3_literals Z3_get_relevant_labels (Z3_context c);
...
*/
Z3_literals Z3_get_relevant_literals (Z3_context c);
...
*/
Z3_literals Z3_get_guessed_literals (Z3_context c);
...
*/
void Z3_del_literals (Z3_context c, Z3_literals lbls);
...
*/
uint Z3_get_num_literals (Z3_context c, Z3_literals lbls);
...
*/
Z3_symbol Z3_get_label_symbol (Z3_context c, Z3_literals lbls, uint idx);
...
*/
Z3_ast Z3_get_literal (Z3_context c, Z3_literals lbls, uint idx);
...
*/
void Z3_disable_literal (Z3_context c, Z3_literals lbls, uint idx);
...
*/
void Z3_block_literals (Z3_context c, Z3_literals lbls);
...
*/
uint Z3_get_model_num_constants (Z3_context c, Z3_model m);
...
*/
Z3_func_decl Z3_get_model_constant (Z3_context c, Z3_model m, uint i);
...
*/
uint Z3_get_model_num_funcs (Z3_context c, Z3_model m);
...
*/
Z3_func_decl Z3_get_model_func_decl (Z3_context c, Z3_model m, uint i);
...
*/
Z3_bool Z3_eval_func_decl (Z3_context c, Z3_model m, Z3_func_decl decl, Z3_ast* v);
...
*/
Z3_bool Z3_is_array_value (Z3_context c, Z3_model m, Z3_ast v, uint* num_entries);
...
*/
Z3_ast Z3_get_model_func_else (Z3_context c, Z3_model m, uint i);
...
*/
uint Z3_get_model_func_num_entries (Z3_context c, Z3_model m, uint i);
...
*/
uint Z3_get_model_func_entry_num_args (
    Z3_context c,
    Z3_model m,
    uint i,
    uint j);
...
*/
Z3_ast Z3_get_model_func_entry_arg (
    Z3_context c,
    Z3_model m,
    uint i,
    uint j,
...
*/
Z3_ast Z3_get_model_func_entry_value (Z3_context c, Z3_model m, uint i, uint j);
...
*/
Z3_bool Z3_eval (Z3_context c, Z3_model m, Z3_ast t, Z3_ast* v);
...
*/
Z3_string Z3_context_to_string (Z3_context c);
...
*/
Z3_string Z3_statistics_to_string (Z3_context c);
...
*/
Z3_bool Z3_algebraic_is_value (Z3_context c, Z3_ast a);
...
*/
Z3_bool Z3_algebraic_is_pos (Z3_context c, Z3_ast a);
...
*/
Z3_bool Z3_algebraic_is_neg (Z3_context c, Z3_ast a);
...
*/
Z3_bool Z3_algebraic_is_zero (Z3_context c, Z3_ast a);
...
*/
Z3_bool Z3_algebraic_lt (Z3_context c, Z3_ast a, Z3_ast b);
...
*/
Z3_bool Z3_algebraic_gt (Z3_context c, Z3_ast a, Z3_ast b);
...
*/
Z3_bool Z3_algebraic_le (Z3_context c, Z3_ast a, Z3_ast b);
...
*/
Z3_bool Z3_algebraic_ge (Z3_context c, Z3_ast a, Z3_ast b);
...
*/
Z3_bool Z3_algebraic_eq (Z3_context c, Z3_ast a, Z3_ast b);
...
*/
Z3_bool Z3_algebraic_neq (Z3_context c, Z3_ast a, Z3_ast b);
...
*/
Z3_bool Z3_rcf_lt (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
Z3_bool Z3_rcf_gt (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
Z3_bool Z3_rcf_le (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
Z3_bool Z3_rcf_ge (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
Z3_bool Z3_rcf_eq (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
Z3_bool Z3_rcf_neq (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
Z3_string Z3_rcf_num_to_string (Z3_context c, Z3_rcf_num a, Z3_bool compact, Z3_bool html);
...
*/
Z3_string Z3_rcf_num_to_decimal_string (Z3_context c, Z3_rcf_num a, uint prec);
...
Z3_ast_vector Z3_get_interpolant (Z3_context c, Z3_ast pf, Z3_ast pat, Z3_params p);
...
Z3_lbool Z3_compute_interpolant (
    Z3_context c,
    Z3_ast pat,
    Z3_params p,
...
int Z3_read_interpolation_problem (
    Z3_context ctx,
    uint* num,
    Z3_ast** cnsts,
    uint** parents,
...
void Z3_write_interpolation_problem (
    Z3_context ctx,
    uint num,
    Z3_ast* cnsts,
    uint* parents,
...
*/
Z3_ast Z3_mk_fpa_inf (Z3_context c, Z3_sort s, Z3_bool negative);
...
*/
Z3_ast Z3_mk_fpa_zero (Z3_context c, Z3_sort s, Z3_bool negative);
...
*/
Z3_ast Z3_mk_fpa_numeral_int_uint (Z3_context c, Z3_bool sgn, int exp, uint sig, Z3_sort ty);
...
*/
Z3_ast Z3_mk_fpa_numeral_int64_uint64 (Z3_context c, Z3_bool sgn, long exp, ulong sig, Z3_sort ty);
...
/**
    ...
    */
Z3_bool Z3_fpa_get_numeral_sign (Z3_context c, Z3_ast t, int* sgn);
...
/**
    ...
    */
Z3_string Z3_fpa_get_numeral_significand_string (Z3_context c, Z3_ast t);
...
*/
Z3_bool Z3_fpa_get_numeral_significand_uint64 (Z3_context c, Z3_ast t, ulong* n);
...
/**
    ...
    */
Z3_string Z3_fpa_get_numeral_exponent_string (Z3_context c, Z3_ast t);
...
/**
    ...
    */
Z3_bool Z3_fpa_get_numeral_exponent_int64 (Z3_context c, Z3_ast t, long* n);
